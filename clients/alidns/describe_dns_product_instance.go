...
func (r DescribeDnsProductInstanceRequest) Invoke(client *sdk.Client) (response *DescribeDnsProductInstanceResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeDnsProductInstanceResponse
