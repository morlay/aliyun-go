...
func (r DescribeScalingInstancesRequest) Invoke(client *sdk.Client) (response *DescribeScalingInstancesResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeScalingInstancesResponse
