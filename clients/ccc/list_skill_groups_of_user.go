...
func (r ListSkillGroupsOfUserRequest) Invoke(client *sdk.Client) (response *ListSkillGroupsOfUserResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.ListSkillGroupsOfUserResponse
