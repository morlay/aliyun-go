...
func (r UpdateTerrorismPipelineRequest) Invoke(client *sdk.Client) (response *UpdateTerrorismPipelineResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.UpdateTerrorismPipelineResponse
