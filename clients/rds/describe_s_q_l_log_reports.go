...
func (r DescribeSQLLogReportsRequest) Invoke(client *sdk.Client) (response *DescribeSQLLogReportsResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeSQLLogReportsResponse
