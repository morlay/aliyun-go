...
func (r DescribeSQLLogRecordsRequest) Invoke(client *sdk.Client) (response *DescribeSQLLogRecordsResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeSQLLogRecordsResponse
