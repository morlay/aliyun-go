...
func (r CreateLoadBalancerTCPListenerRequest) Invoke(client *sdk.Client) (response *CreateLoadBalancerTCPListenerResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.CreateLoadBalancerTCPListenerResponse
