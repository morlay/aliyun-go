...
func (r DescribeInstancesFullStatusRequest) Invoke(client *sdk.Client) (response *DescribeInstancesFullStatusResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeInstancesFullStatusResponse
