...
func (req *CreateClusterTemplateRequest) Invoke(client *sdk.Client) (resp *CreateClusterTemplateResponse, err error) {
	req.InitWithApiInfo("Emr", "2016-04-08", "CreateClusterTemplate", "", "")
