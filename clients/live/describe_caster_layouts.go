...
func (r DescribeCasterLayoutsRequest) Invoke(client *sdk.Client) (response *DescribeCasterLayoutsResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	req.InitWithApiInfo("live", "2016-11-01", "DescribeCasterLayouts", "", "")
	...
	response = &resp.DescribeCasterLayoutsResponse
