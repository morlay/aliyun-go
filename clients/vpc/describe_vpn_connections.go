...
func (r DescribeVpnConnectionsRequest) Invoke(client *sdk.Client) (response *DescribeVpnConnectionsResponse, err error) {
	req := struct {
		*requests.RpcRequest
	...
	response = &resp.DescribeVpnConnectionsResponse
